...
cases :: Prog -> Goal -> String -> String -> String -> String -> IO ()
cases p g s f goal _ = putStrLn (solveWith p (parse goal) s) 
...
cases p g s f ":t" goal = putStrLn (pretty (sld p (parse goal)))
